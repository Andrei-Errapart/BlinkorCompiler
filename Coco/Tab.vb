...
Namespace at.jku.ssw.Coco
	...
	Public Class Position     ' position of source code stretch (e.g. semantic action, resolver expressions)
		Public beg   As Integer ' start relative to the beginning of the file
		Public [end] As Integer ' end of stretch
		Public col   As Integer ' column number of start position
		Public Sub New(ByVal beg As Integer, ByVal [end] As Integer, ByVal col As Integer)
			Me.beg   = beg
			Me.[end] = [end]
			Me.col   = col
		End Sub
	...
	Public Class Tab
		...
		Public Function AllNtReached() As Boolean
			...
			For Each sym As Symbol In nonterminals
				If Not visited(sym.n) Then
					ok = False
					errors.SemErr(Space(2) & sym.name & " cannot be reached")
				End If
			Next
			Return ok
		End Function
